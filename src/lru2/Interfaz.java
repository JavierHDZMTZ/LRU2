...
public class Interfaz extends javax.swing.JFrame {
    ...
    public Interfaz() {
       ...
       jComboBox4.addItem("KB");
       jComboBox4.addItem("MB");
       jComboBox4.addItem("GB");
       
       jComboBox5.removeAllItems();
       jComboBox5.addItem("Seleccione");
       jComboBox5.addItem("KB");
       jComboBox5.addItem("MB");
       jComboBox5.addItem("GB");
       // Text Fields
    ...
    private void initComponents() {
        ...
        jLabel4.setText("No. Marco de Páginas");

        jLabel5.setText("No. de Páginas");
        ...
        jTextField5.setBackground(new java.awt.Color(133, 193, 233));
        ...
        jTextField6.setBackground(new java.awt.Color(133, 193, 233));
        jTextField6.setHorizontalAlignment(javax.swing.JTextField.CENTER);

        jTextField7.setEditable(false);
        jTextField7.setBackground(new java.awt.Color(133, 193, 233));
        ...
        jTextField8.setBackground(new java.awt.Color(133, 193, 233));
        jTextField8.setHorizontalAlignment(javax.swing.JTextField.CENTER);

        jPanel2.setBackground(new java.awt.Color(31, 97, 141));

        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Generacion de Instrucciones");
        ...
        jButton4.setText("Comenzar Ejecucion");
        ...
        jButton6.setText("Fallo de pagina");
        ...
        jLabel10.setText("Tamaño de Pagina");
        ...
        jPanel4.setBackground(new java.awt.Color(31, 97, 141));
        ...
        jPanel6.setBackground(new java.awt.Color(31, 97, 141));

        jLabel11.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("VRAM");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int mult1=0, mult2=0, mult3=0;
        String CB1, CB2, CB3;
        RAM= Integer.parseInt(jTextField1.getText());
        VRAM= Integer.parseInt(jTextField2.getText());
        Tpag= Integer.parseInt(jTextField3.getText());
        CB1=jComboBox4.getSelectedItem().toString();
        CB2=jComboBox5.getSelectedItem().toString();
        CB3=jComboBox3.getSelectedItem().toString();
        if(CB1.equals("KB")){
            mult1=1;
        }else{
            if(CB1.equals("MB")){
